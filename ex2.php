          ...
          <div class="card-body">
            <form action="" method="get">
              <div class="form-group">
                ...
                <input class="form-control" type="number" name="priceK" id="priceK" placeholder="Valor do quilo">
              </div>
              <div class="form-group">
                <label for="price">Total de quilos comprados:</label>
                <input class="form-control" type="number" name="buyK" id="buyK" placeholder="Total de quilos">
              </div> <br>
